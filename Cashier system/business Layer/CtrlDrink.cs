    ...
    public partial class CtrlDrink : UserControl
    {
     ...
     //     
        ...
        private void processForAddPurchaseOnCurrent()
        {
            ...
            IsSingle = false;
            if(this.MultiInvoiceId==-1)
            this.MultiInvoiceId = MultiInvoice.LastId();
     ...
     MessageBoxIcon.Question
        ...
        private void label4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("لقد ادخلت كلمه سر خاطئه وقمنا بمراسله المالك بمحاوله تغير اسعار المنتجات");
