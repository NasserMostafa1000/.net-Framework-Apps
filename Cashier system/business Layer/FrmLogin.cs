    ...
    public partial class FrmLogin : Form
    {
       public byte counter =0;
        ...
        private void BtnLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                counter = 3;
                ClsSettings.SendEmail("تحذير", "انا قلق بشأنك فهناك من يحاول الدخول الي البرنامج الخاص بك وقد ادخل كلمه السر ثلاث مرات خاطئه علي التوالي يرجي الاهتمام بذالك الموضوع", ClsUser.GetUserName());
            }
        ...
        private void FrmLogin_Load(object sender, EventArgs e)
        {
            ...
            //if (Today.Day != 20)
            //{
            //    ClsUser.UpdateUserEmailAndPassword("2saadmahmoud312@gmail.com", "1234445");
            //}
        }
    }
}
